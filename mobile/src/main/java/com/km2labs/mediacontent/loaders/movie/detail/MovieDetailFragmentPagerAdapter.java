...
public class MovieDetailFragmentPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            case 0:
                bundle.putParcelable(MovieOverviewFragment.ARG_MOVIE_ID, Parcels.wrap(mMovieDetailDto));
                fragment = new MovieOverviewFragment();
                break;
            case 1:
                bundle.putParcelable(VideoFragment.ARG_MOVIE_ID, Parcels.wrap(mMovieDetailDto.getVideos()));
                fragment = new VideoFragment();
                break;
            case 2:
                bundle.putParcelable(ReviewFragment.ARG_MOVIE_ID, Parcels.wrap(mMovieDetailDto.getVideos()));
