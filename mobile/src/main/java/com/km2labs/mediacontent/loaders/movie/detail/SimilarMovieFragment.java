...
public class SimilarMovieFragment extends RecyclerViewFragment<SimilarMovieContract.View, SimilarMovieContract.Presenter> implements SimilarMovieContract.View {
    ...
    @Override
    protected PresenterFactory<SimilarMovieContract.Presenter> getPresenterFactory() {
        return () -> new SimilarMoviePresenter(RetrofitHelper.getRetrofitHelper().createService(MovieService.class), new InMemoryCache());
    }
